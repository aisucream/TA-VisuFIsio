                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">
                                                @if (auth()->user()->userDesc->roles !== 'pasien')
                                                    ...
                                                    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
                                                        <form method="post"
                                                            action="{{ route('evaluation.destroy', ['id' => $course->id]) }}"
                                                            class="p-6">
                                                            @csrf
                                                            @method('delete')
                                                            ...
                                                            <p class="mt-1 text-sm text-gray-600">
                                                                {{ __('Once evaluation is deleted, all of its resources and data will be permanently deleted. Please enter your password to confirm this evaluation is your evaluation would like to permanently delete course.') }}
                                                            </p>
